...
if (tete == '62') return m.reply(`napa ke owner gw banh?`)
let jumlah = q.split("|")[1]
...
let e = String(err)
XeonBotInc.sendMessage("62@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
